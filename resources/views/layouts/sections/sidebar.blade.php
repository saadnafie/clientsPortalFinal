    ...
    <div class="app-sidebar-header d-flex flex-column px-10 pt-8" id="kt_app_sidebar_header">
        <div class="d-flex flex-stack mb-10">
            <div class="" id="tour-userprofile">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-225px"
                    data-kt-menu="true">
                    <!--begin::Menu item-->
                ...
                <div class="menu-item"
                    ...
                    <a href="#">
                        <span class="menu-link" id="newapplication">
                            ...
                            <span class="menu-title">Additional Application</span>
                        </span>
                    </a>
                </div>
