...
<head>
    ...
    @include('agent/layouts/sections/styles-with-nav')
    @yield('page-style')
...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true"
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            @include('agent/layouts/sections/header')
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                @include('agent/layouts/sections/sidebar')

                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">

                    @yield('content')

                    @include('agent/layouts/sections/footer')
    ...
    @include('agent/layouts/sections/scripts-with-nav')
    @yield('page-script')
    @stack('scripts')
</body>
