                    ...
                    <tr>
                        <td align="center" bgcolor="#343e9e" class="container-padding">
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="center" class="center-text">
                                        <img style="width:190px;border:0px;display: inline!important;"
                                            src="{{ asset('assets/img/emails/Email-18_Intro.png') }}" width="90"
                                            border="0" alt="intro">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="center-text" align="center"
                                        style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:22px;line-height:32px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">

                                        <div>
                                            {{ __('pleb.mail.Invoice ID') }}: {{ $application_serial }}
                                        </div>
