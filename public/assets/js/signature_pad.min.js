!(function (a, b) {
     ...
     */ var a = (function (a) {
        ...
        var b = function (a, b) {
            var c = this,
                d = b || {};
            (this.velocityFilterWeight = d.velocityFilterWeight || 0.7),
                (this.minWidth = d.minWidth || 0.5),
                (this.maxWidth = d.maxWidth || 2.5),
                (this.dotSize =
                    d.dotSize ||
                    function () {
                        return (this.minWidth + this.maxWidth) / 2;
                    }),
                (this.penColor = d.penColor || "black"),
                (this.backgroundColor = d.backgroundColor || "rgba(0,0,0,0)"),
                (this.onEnd = d.onEnd),
                (this.onBegin = d.onBegin),
                (this._canvas = a),
                (this._ctx = a.getContext("2d")),
                this.clear(),
                (this._handleMouseDown = function (a) {
                    1 === a.which &&
                        ((c._mouseButtonDown = !0), c._strokeBegin(a));
                }),
                ...
                (this._handleMouseUp = function (a) {
                    1 === a.which &&
                        c._mouseButtonDown &&
                        ((c._mouseButtonDown = !1), c._strokeEnd(a));
                }),
        ...
        (b.prototype.clear = function () {
            ...
            (b.prototype._handleMouseEvents = function () {
                (this._mouseButtonDown = !1),
                    ...
                    a.addEventListener("mouseup", this._handleMouseUp);
            }),
            ...
            (b.prototype.off = function () {
                this._canvas.removeEventListener(
                    ...
                    a.removeEventListener("mouseup", this._handleMouseUp),
                    this._canvas.removeEventListener(
                        "touchstart",
                        this._handleTouchStart
                    ),
