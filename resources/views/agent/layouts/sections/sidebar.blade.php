<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-header d-flex flex-column px-10 pt-8" id="kt_app_sidebar_header">
        <div class="d-flex flex-stack mb-10">
            <div class="" id="tour-userprofile">
                <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                    data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
                    <div class="d-flex flex-center cursor-pointer symbol symbol-custom symbol-40px border border-primary border-5"
                        style="border-color: #E96559 !important;">
                        @if(is_null(auth()->user()->avatar))
                        <img src="{{asset('assets/media/avatars/blank-main-page.jpg')}}" alt="image" />
                        @else
                        <img src="{{asset('assets/media/avatars/'.auth()->user()->avatar)}}" alt="image" />
                        @endif
                    </div>
                    <a href="{{ route('account.show') }}"
                        class="text-white text-hover-primary fs-4 fw-bold ms-3">@yield('username')</a>
                </div>
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                @if(is_null(auth()->user()->avatar))
                                <img alt="Logo" src="{{asset('assets/media/avatars/blank-main-page.jpg')}}" />
                                @else
                    ...
                    <div class="menu-item px-5">
                        <a href="{{ route('account.edit') }}" class="menu-link px-5">
                        ...
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            ...
                            <div class="menu-item px-3">
                                <a href="#" class="menu-link d-flex px-5">
                                    <span class="symbol symbol-20px me-4">
                                        <img class="rounded-1" src="{{asset('assets/media/flags/saudi-arabia.svg')}}"
                                            alt="" />
                                    </span>Arabic</a>
                            </div>
                        </div>
                    ...
                    <div class="menu-item px-5 my-1">
                        <a href="{{ route('account.edit') }}" class="menu-link px-5">Account
                            Settings</a>
                    </div>
                    <div class="menu-item px-5">
    ...
    <div class="app-sidebar-navs flex-column-fluid" id="kt_app_sidebar_navs">
        <div id="kt_app_sidebar_navs_wrappers" class="hover-scroll-y my-2" data-kt-scroll="true"
            ...
            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                class="menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary">
                <!--begin::Heading-->
                <div class="menu-item">
                ...
                <!--end::Heading-->
                <!--begin:Menu item-->
                <div class="menu-item" id="tour-dashboard">
                    <a href="{{ route('agent-dashboard') }}">
                        <span class="menu-link" id="dashboard">
                            <span class="menu-icon">
                                <i class="fonticon-house fs-2 csg-color"></i>
                            </span>
                ...
                <div class="menu-item" id="tour-dashboard">
                    <a href="{{ route('user-list.index') }}">
                        <span class="menu-link" id="dashboard">
                            <span class="menu-icon">
                                <i class="fonticon-user fs-2 csg-color"></i>
                            </span>
                ...
                <div class="menu-item" id="tour-dashboard">
                    <a href="{{ route('application-list.index') }}">
                        <span class="menu-link" id="dashboard">
                            <span class="menu-icon">
                                <i class="fas fa-layer-group fs-2 csg-color"></i>
                            </span>
                ...
                <div class="menu-item" id="tour-dashboard">
                    <a href="{{ route('invoice-list.index') }}">
                        <span class="menu-link" id="dashboard">
                            <span class="menu-icon">
                                <i class="fas fa-file-invoice-dollar fs-2 csg-color"></i>
                            </span>
                ...
                <div class="menu-item" id="tour-dashboard">
                    <a href="{{ route('activitylog-list.index') }}">
                        <span class="menu-link" id="dashboard">
                            <span class="menu-icon">
                                <i class="fas fa-history fs-2 csg-color"></i>
                            </span>
                ...
                <!--<div class="menu-item" id="tour-newapplication">
                    <a href="{{ route('applications.create') }}">
                        <span class="menu-link" id="create">
                            <span class="menu-icon">
                                <i class="fonticon-stats fs-2 csg-color"></i>
                            </span>
                ...
                <div class="menu-item">
                    <a href="#">
                        <span class="menu-link">
                            ...
                            <span class="menu-title">Verification History</span>
                        </span>
                    </a>
                </div>
                <div class="menu-item">
            ...
            <div class="menu menu-rounded menu-column">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Active Applications</span>
                        <span class="menu-badge">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Closed Applications</span>
                        <span class="menu-badge">
                            <span class="badge badge-custom">0</span>
                        </span>
                    </a>
