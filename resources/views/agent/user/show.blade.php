            ...
            <div class="card-body pt-1">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key+1 }}</td>
                            <td>{{ $userApplication->application_name }}</td>
                            <td>{{ $userApplication->application_serial }}</td>
                            <td>{{ $userApplication->application_type }}</td>
                            <td>{{ $userApplication->status->application_status }}</td>
                            <td>{{ date($userApplication->created_at) }}</td>
                            <td>-</td>
                        </tr>
                        @endforeach
                    </tbody>
