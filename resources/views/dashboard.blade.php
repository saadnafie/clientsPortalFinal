                    ...
                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center border-0 h-md-50 mb-5 mb-xl-10"
                        ...
                        <div class="card-header pt-5">
                            <div class="card-title d-flex flex-column">
                                <span class="fs-1hx fw-bold text-white me-1 lh-1 ls-n2">Application
                                    Name</span>
                                <span class="text-white opacity-50 pt-1 fw-semibold fs-6">#529fd34</span>
                            </div>
                            <div class="d-flex">
                                <a href="#" class="align-self-center"><i class="fas fa-edit fa-3x"
                                        aria-hidden="true"></i>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                                        <a href="#" class="btn btn-sm btn-warning fw-bold ms-2 fs-8 py-1 px-3">
                                            Checkout</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card card-flush h-md-50 mb-5 mb-xl-10">
                        <div class="card-header pt-5">
                            <div class="card-title d-flex flex-column">
                                ...
                                <span class="text-gray-400 pt-1 fw-semibold fs-6">Total amount
                                    paid</span>
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-5">
                            <div class="d-flex flex-stack">
                                <div class="text-gray-700 fw-semibold fs-6 me-2">
                                    Total Educational Certificates
                                </div>
                            ...
                            <div class="d-flex flex-stack">
                                <div class="text-gray-700 fw-semibold fs-6 me-2">
                                    Total Health License
                                </div>
                                <div class="d-flex align-items-senter">
                                    <span class="text-gray-900 fw-bolder fs-6">10</span>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-3"></div>
                            <div class="d-flex flex-stack">
