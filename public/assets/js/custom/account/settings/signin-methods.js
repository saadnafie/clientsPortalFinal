...
var KTAccountSettingsSigninMethods = (function () {
    var t,
        ...
        dd = function () {
            ee.classList.toggle("d-none"),
                ss.classList.toggle("d-none"),
                nn.classList.toggle("d-none");
        },
        c = function () {
    ...
    return {
        init: function () {
            ...
            (t = document.getElementById("kt_signin_change_email")),
                ...
                (ee = document.getElementById("kt_signin_phone")),
                (nn = document.getElementById("kt_signin_phone_edit")),
                ...
                (ss = document.getElementById("kt_signin_phone_button")),
                (r = document.getElementById("kt_signin_cancel")),
                (rr = document.getElementById("kt_signin_cancel_phone")),
