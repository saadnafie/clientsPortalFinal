...
!(function (t, e) {
            ...
            (S.prototype = {
                ...
                finish: function (t) {
                    for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                        ...
                        if (n.finallyLoc === t)
                            return (
                                this.complete(n.completion, n.afterLoc), k(n), h
                            );
                    }
                },
                catch: function (t) {
    ...
    var ct = R,
        ...
        It = function (t) {
            return (
                "Symbol(" + (void 0 === t ? "" : t) + ")_" + Nt(++At + Et, 36)
            );
        },
        Lt = _t("wks"),
        Tt = B.Symbol,
                                  ...
                                  (n = {
                                      configurable:
                                          te in n
                                              ...
                                              : r.configurable,
                                      enumerable:
                                          Zt in n ? n.enumerable : r.enumerable,
                                      writable: !1,
                                  }));
                          }
                          return Qt(t, e, n);
            ...
            var e = se.CONFIGURABLE,
                ...
                i =
                    ...
                    !y(function () {
                        return (
                            8 !==
                            o(function () {}, "length", { value: 8 }).length
                        );
                    }),
                ...
                s = (t.exports = function (t, r, s) {
                    "Symbol(" === String(r).slice(0, 7) &&
                        ...
                        (!Ct(t, "name") || (e && t.name !== r)) &&
                            (M
                                ? o(t, "name", { value: r, configurable: !0 })
                                : (t.name = r)),
                        i &&
                            s &&
                            Ct(s, "arity") &&
        ...
        wn =
            M && !Vt
                ...
                : function (t, e) {
                      Kt(t);
                      for (
                          var n, r = Q(e), o = yn(e), i = o.length, a = 0;
                          i > a;
        ...
        (Mn = function (t) {
            ...
            if (
                ...
                f
                    ...
                    : Gn &&
                      o &&
                      (c.lastIndex = c.global ? o.index + o[0].length : r),
                Wn &&
                    o &&
                    o.length > 1 &&
                    C(qn, o[0], n, function () {
            ...
            return [
                ...
                function (t, o) {
                    ...
                    for (var h = []; ; ) {
                        ...
                        if ((dr(h, p), !l)) break;
                        "" === fn(p[0]) &&
                            (i.lastIndex = tr(a, qe(i.lastIndex), u));
                    }
            ...
            switch (c) {
                ...
                case "top-middle-aligned":
                    (n.className = "introjs-arrow bottom-middle"),
                        r && (h += 5),
                        Er(a, h, i, e) &&
                            ((e.style.right = null), Ar(a, h, i, s, e)),
                        (e.style.bottom = "".concat(a.height + 20, "px"));
                    break;
    ...
    function Dr(t) {
        ...
        ).style.cssText = "width:".concat(Rr.call(this), "%;")),
            t
                        ...
                        for (;;)
                            switch ((t.prev = t.next)) {
                                ...
                                case 24:
                                    if (
                                        !o ||
                                        !o.className.match("introjs-skipbutton")
                                    ) {
                                        t.next = 32;
                                        break;
                                    }
                                ...
                                case 32:
                                    if (
                                        !o ||
                                        !o.getAttribute("data-step-number")
                                    ) {
                                        t.next = 36;
                                        break;
                                    }
                            ...
                            switch ((t.prev = t.next)) {
                                ...
                                case 9:
                                    this._options.hintAutoRefreshInterval >=
                                        0 &&
                                        ((this._hintsAutoRefreshFunction = no(
                                            function () {
                                                return xo.call(i);
                                            },
                                            this._options
                                ...
                                case 0:
                                    ...
                                    c(this._options.hints, function (t) {
                                        ...
                                        "string" == typeof e.element &&
                                            ...
                                            (e.hintAnimation =
                                                e.hintAnimation ||
                                                o._options.hintAnimation),
                                            null !== e.element &&
                                                o._introItems.push(e);
                                    }),
                                        (t.next = 9);
                                    break;
                                case 5:
