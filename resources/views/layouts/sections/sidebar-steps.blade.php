<div id="" class=" app-sidebar  flex-column small-menu" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px"
    data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    <div class="app-sidebar-header d-flex flex-column px-8 pt-8" id="kt_app_sidebar_header">
    ...
    <div class="app-sidebar-navs flex-column-fluid" id="kt_app_sidebar_navs">
        <div id="kt_app_sidebar_navs_wrappers" class="hover-scroll-y my-2" data-kt-scroll="true"
            ...
            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                class="menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary px-7">
                <!--begin::Heading-->
                <div class="menu-item">
                </div>
                <!--end::Heading-->
                <!--begin:Menu item-->
                <div class="menu-item" id="tour-dashboard" title="Dashboard" data-bs-toggle="tooltip"
                    data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <a href="{{ route('dashboard') }}">
                        <span class="menu-link" id="dashboard">
                            <span class="menu-icon">
                                <i class="fonticon-house fs-3 csg-color"></i>
                            </span>
                        </span>
                    </a>
                </div>
                ...
                @if(count($userApplicationsCount) == 0)
                <div class="menu-item" title="Create new application" data-bs-toggle="tooltip" data-bs-trigger="hover"
                    data-bs-dismiss="click" data-bs-placement="right">
                    <a href="{{ route('applications.create') }}">
                        <span class="menu-link" id="newapplication">
                            <span class="menu-icon">
                                <i class="fonticon-content-marketing fs-2 csg-color"></i>
                            </span>
                        </span>
                    </a>
                </div>
                @elseif(count($userApplicationsCount) == 1 && $userApplicationsCount[0]->status_id == 1)
                <div class="menu-item"
                    title="You should complete the current application to create additional application"
                ...
                @elseif(count($userApplicationsCount) == 1 && $userApplicationsCount[0]->status_id == 2)
                <div class="menu-item" title="Create additional application" data-bs-toggle="tooltip"
                    data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <a href="{{ route('applications.create') }}">
                        <span class="menu-link" id="newapplication">
                            <span class="menu-icon">
                ...
                @else
                <div class="menu-item" title="You already have the max limit number of applications"
                    data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <a href="#">
                        <span class="menu-link" id="newapplication">
                            <span class="menu-icon">
                ...
                <div class="menu-item" title="Verification History" data-bs-toggle="tooltip" data-bs-trigger="hover"
                    data-bs-dismiss="click" data-bs-placement="right">
                    <a href="{{ route('verification_history') }}">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <i class="fas fa-history p-7 csg-color"></i>
                            </span>
                        </span>
                    </a>
                </div>
                <div class="menu-item" title="Invoices" data-bs-toggle="tooltip" data-bs-trigger="hover"
                    data-bs-dismiss="click" data-bs-placement="right">
                    <a href="{{ route('invoices') }}">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <i class="fas fa-file-invoice-dollar p-7 csg-color"></i>
                            </span>
                        </span>
                    </a>
                </div>
